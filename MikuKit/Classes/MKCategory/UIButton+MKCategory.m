...
+ (UIButton *)mk_buttonWithNormalTitle:(NSString *)mormalTitle
    ...
    [btn setBackgroundColor:normalBgColor];
    return btn;
}
...
+ (instancetype)mk_textButtonWithFont:(UIFont *)font
    ...
    [btn setBackgroundImage:[UIImage mk_imageWithColor:normalBGColor] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage mk_imageWithColor:disableBGColor] forState:UIControlStateDisabled];
    return btn;
}
